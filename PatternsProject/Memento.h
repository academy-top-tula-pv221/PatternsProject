...
public:
	...
	PlayerMemento(int points, int level) : points{ points }, level{ level } {}
};
...
public:
	...
	void Play()
	{
		...
		cout << "current player with: points [" << points << "], level [" << level << "]\n";
	}

	PlayerMemento* Save()
	{
		cout << "save player with: points [" << points << "], level [" << level << "]\n";
	...
	void Load(PlayerMemento* memento)
	{
		...
		level = memento->Level();
		cout << "load player with: points [" << points << "], level [" << level << "]\n";
	}
};
